  ...
  if (readOnly) {
    return (
      ...
      >
        ...
        <span className="flex-1 text-sm sm:text-base text-[#7A6B60] dark:text-muted-foreground/70 whitespace-nowrap overflow-hidden text-ellipsis">
      ...
      <form onSubmit={handleFormSubmit} className="w-full">
        <div className="relative flex items-center bg-white dark:bg-[#1E1710] border border-[#EFE4D7] dark:border-zinc-800/80 rounded-[28px] shadow-[0_12px_40px_rgba(80,45,20,0.06)] px-3 pl-6 pr-2 h-14 md:h-16 focus-within:border-[#6A2C2A] dark:focus-within:border-[#E8B15C] focus-within:ring-2 focus-within:ring-[#6A2C2A]/10 transition-all duration-300">
          ...
          <input
            ...
            className="w-full bg-transparent border-0 outline-none focus:outline-none focus:ring-0 text-[#32251E] dark:text-foreground text-sm sm:text-base md:text-base font-medium placeholder:text-[#7A6B60]/70 py-2.5"
            autoFocus={autoFocus}
          />
