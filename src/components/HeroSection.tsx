...
export function HeroSection({ stats }: HeroSectionProps) { 
  ...
  return ( 
    <section className="hero-section w-full px-4 sm:px-6 md:px-8 lg:px-10 py-6 md:py-8 bg-background"> 
      <div className="relative w-full overflow-hidden rounded-2xl md:rounded-[32px] min-h-[85vh] md:h-[620px] lg:h-[700px] flex flex-col justify-end md:justify-center p-6 sm:p-10 md:p-16 lg:p-20 shadow-[0_20px_50px_rgba(0,0,0,0.12)] dark:shadow-[0_24px_60px_rgba(0,0,0,0.5)] border border-orange-200/30 dark:border-zinc-800/60">
        ...
        <div className="absolute inset-0 z-0 bg-stone-950"> 
          ...
          {/* Gradients contained inside the box */}
          {/* Mobile vertical gradient overlay */}
          <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/50 via-60% to-transparent md:hidden" />
          
          {/* Desktop horizontal gradient overlay for left-aligned content readability */}
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/55 via-45% to-transparent hidden md:block" />
          
          {/* Subtle top shadow */}
          <div className="absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-black/30 to-transparent pointer-events-none" />
        </div>

        {/* Mobile-only spacer to push content to the bottom of the poster on mobile */}
        <div className="flex-1 md:hidden" />

        {/* HERO CONTENT — positioned upper/middle area on desktop, bottom on mobile */}
        <div className="relative z-10 flex flex-col items-center md:items-start w-full md:max-w-2xl text-center md:text-left">
          ...
          <motion.h1 
            ...
            className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-b from-amber-100 via-amber-200 to-amber-400 leading-tight mb-4 drop-shadow-[0_4px_12px_rgba(0,0,0,0.85)] selection:bg-amber-500/30"
          >
          ...
          <motion.div
            ...
            className="flex items-center justify-center md:justify-start gap-2.5 mb-4 md:mb-5 w-full md:w-auto"
          >
