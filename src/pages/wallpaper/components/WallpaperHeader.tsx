...
export const WallpaperHeader: React.FC<WallpaperHeaderProps> = React.memo(({
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-40 backdrop-blur-md px-4 py-3 flex items-center justify-between w-full select-none border-b",
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2.5">
          <div
            className={cn(
              "w-9 h-9 rounded-full border p-1.5 flex items-center justify-center shadow-sm",
              isDark ? "bg-card border-amber-500/30" : "bg-white border-[#651317]/20"
            )}
          >
