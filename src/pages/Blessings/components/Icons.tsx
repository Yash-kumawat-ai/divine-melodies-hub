// ─── BLESSINGS PAGE CUSTOM ICONS ──────────────────────────────────
// Pure SVG presentational components. No state, no side effects.
...
export const CustomDownloadIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
