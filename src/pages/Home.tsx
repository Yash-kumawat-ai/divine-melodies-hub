        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="text-center mb-8 md:mb-12">
            <div className="flex items-center justify-center gap-3 mb-2">
              <div className="h-px w-10 bg-gradient-to-r from-transparent to-[#651317]/60" />
              <span className="text-[#651317] dark:text-[#D4A437] text-[11px] font-black uppercase tracking-[0.2em] font-sans">✦ ✦ ✦</span>
              <div className="h-px w-10 bg-gradient-to-l from-transparent to-[#651317]/60" />
            </div>
            <h2 className="font-serif text-3xl font-black text-[#3A2418] dark:text-[#FFFDF8]">
              {isHi ? 'राघवम् की विशेषताएं' : 'Explore Features'}
            </h2>
            <p className="text-[#786252] dark:text-stone-400 text-sm mt-2">
