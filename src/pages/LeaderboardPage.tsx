...
/** Shared rank numeral style — same size/weight everywhere */
const RANK_NUM =
...
/** Modern filled crown for 1st place */
...
function PodiumColumn({
  ...
  return (
    ...
    >
      ...
      {/* Stepped pedestal with unified rank numeral */}
      <div
        className={cn(
...
export default function LeaderboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF6EE] dark:bg-[#0c0a08] pb-28 text-[#3A2418] relative overflow-x-hidden select-none">
      {/* Soft cream wash — no photo */}
      <div
        className="pointer-events-none absolute inset-0 z-0"
        style={{
          background:
            "linear-gradient(180deg, #FFFDF8 0%, #FAF6EE 40%, #F5EDE0 100%)",
        }}
      />
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex flex-col items-end shrink-0 pl-2">
                            ...
                            <span className="text-[9px] text-[#786252] font-medium mt-0.5">
                              {t.chants}
                            </span>
                          </div>
                        </motion.div>
