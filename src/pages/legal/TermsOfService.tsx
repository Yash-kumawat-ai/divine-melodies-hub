...
export default function TermsOfService() {
  return (
    <div className="min-h-screen bg-background font-body">
      <SEO title="Terms of Service" description="Terms and conditions for using the Raghavam platform." />
      <article className="py-12 md:py-16 px-4">
        <div className="container mx-auto max-w-3xl prose prose-neutral dark:prose-invert">
          ...
          <section className="space-y-4 text-foreground/80 text-base leading-relaxed">
            ...
            <p>By accessing or using Raghavam, you agree to be bound by these Terms of Service. If you do not agree, please do not use the platform.</p>

            <h2 className="font-display text-xl font-bold text-foreground mt-8">2. User Conduct</h2>
            <p>You agree to use Raghavam respectfully and lawfully. You must not upload content that is offensive, hateful, infringing, or unrelated to devotional music. Spam, harassment, and automated scraping are prohibited.</p>

            <h2 className="font-display text-xl font-bold text-foreground mt-8">3. Content Ownership</h2>
            <p>When you upload a bhajan, you retain ownership of your original content. By uploading, you grant Raghavam a non-exclusive, worldwide license to display and distribute your content on the platform. You represent that you have the right to share the content you upload.</p>
            ...
            <p>We respect intellectual property rights. If you believe content on our platform infringes your copyright, please contact us at support@raghavam.com with details of the alleged infringement. We will investigate and take appropriate action, including removing infringing content.</p>
            ...
            <p>Raghavam is provided "as is" without warranties of any kind. We are not liable for any damages arising from your use of the platform, including loss of data or service interruptions.</p>
            ...
            <p>For questions about these terms, contact us at <a href="mailto:support@raghavam.com" className="text-brand-saffron hover:underline">support@raghavam.com</a>.</p>
          </section>
        </div>
      </article>
    </div>
