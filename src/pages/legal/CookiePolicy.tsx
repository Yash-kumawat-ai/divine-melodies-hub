...
export default function CookiePolicy() {
  return (
    <div className="min-h-screen bg-background font-body">
      <SEO title="Cookie Policy" description="How Hari Kirtan uses cookies and how to manage them." />
      <article className="py-12 md:py-16 px-4">
        <div className="container mx-auto max-w-3xl prose prose-neutral dark:prose-invert">
          ...
          <section className="space-y-4 text-foreground/80 text-base leading-relaxed">
            ...
            <p>Hari Kirtan uses only essential cookies required for the platform to function. These are:</p>
            ...
            <p>If you have questions about our cookie practices, contact us at <a href="mailto:support@harikirtan.com" className="text-brand-saffron hover:underline">support@harikirtan.com</a>.</p>
          </section>
        </div>
      </article>
    </div>
