...
export default function DMCAPage() {
  ...
  return (
    <div className="min-h-screen bg-[#070302] text-amber-50 p-4 md:p-8 pb-24">
      <SEO
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="flex items-center">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors text-xs font-bold uppercase tracking-wider"
          >
        ...
        {/* Card Panel */}
        <div className="p-6 md:p-10 border border-orange-900/20 bg-[#2a1a08]/30 rounded-3xl space-y-6 shadow-xl">
          <div className="flex items-center gap-3 text-orange-400">
            <ShieldAlert className="w-8 h-8" />
            <h1 className="font-serif font-black text-2xl md:text-3xl">
              {isHi ? 'डीएमसीए कॉपीराइट नीति' : 'DMCA Copyright Policy'}
            </h1>
          </div>

          <div className="space-y-4 text-sm text-stone-300 leading-relaxed font-medium">
            <p>
              {isHi 
            ...
            <div className="border-l-4 border-orange-500/40 pl-4 py-1 my-6 italic text-stone-400">
              <p className="font-bold text-xs uppercase tracking-wider text-orange-400 mb-1">
            ...
            <h2 className="font-serif text-lg font-bold text-stone-200 pt-2">
            ...
            <h2 className="font-serif text-lg font-bold text-stone-200 pt-4">
              {isHi ? 'नामित एजेंट संपर्क' : 'Designated Copyright Agent'}
            </h2>
            
            <div className="flex items-center gap-3 p-4 bg-[#1b0e06] border border-orange-500/10 rounded-2xl max-w-sm">
              <Mail className="w-6 h-6 text-orange-400" />
              <div>
                <p className="font-bold text-xs uppercase tracking-wider text-orange-400">Email Address</p>
                <a href="mailto:copyright@raghavam.com" className="text-sm font-semibold text-white hover:text-orange-400 transition-colors">
