...
const translations: Record<SupportedLanguage, Partial<Record<TranslationKey, string>>> = {
  ...
  gu: {
    ...
    recent: 'તાજેતરનાં', meditation: 'ધ્યાન', community: 'સમુદાય', temple: 'મંદિર', kirtanAi: 'નારદ AI',
  ...
  mr: {
    ...
    recent: 'अलीकडील', meditation: 'ध्यान', community: 'समूह', temple: 'मंदिर', kirtanAi: 'नारद AI',
  ...
  bn: {
    ...
    recent: 'সাম্প্রতিক', meditation: 'ধ্যান', community: 'সম্প্রদায়', temple: 'মন্দির', kirtanAi: 'নারদ AI',
  ...
  ta: {
    ...
    recent: 'சமீபத்திய', meditation: 'தியானம்', community: 'சமூகம்', temple: 'கோவில்', kirtanAi: 'நாரதர் AI',
